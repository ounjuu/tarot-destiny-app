...
- 🏮 **사주팔자 계산** — manseryeok 라이브러리로 천간지지/오행/음양/띠 자동 계산
- 🏮 **8개 카테고리** — 나의 사주, 오늘/이번 주/이번 달/올해 운세, 연애운, 직업운, 재물운
- 🏮 **일간 기반 해석** — 일간(나 자신)을 중심으로 오행 균형, 인생 흐름 분석
- 🏮 **출생 정보 공유** — 점성술에서 입력한 생년월일/시간 재활용
- 🏮 **카테고리별 기간 제한** — 일/주/월/년/영구
- 🔄 **Gemini → Groq 폴백**
